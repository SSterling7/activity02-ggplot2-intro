...
**Response**: Box plot allows you to identify the spread of the data set and where the quartiles lie. 
...
**Response**: The markdown is easier to read and looks more proffesional.
...
**Response**: jitter over the boxplot as the boxes would cover the points.
...
**Response**: you can map to individual layers vs applying the aesthetic to all layers
